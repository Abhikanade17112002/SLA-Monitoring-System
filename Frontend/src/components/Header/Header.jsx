      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        >
          ...
          <div>
            ...
            <div className="text-xs text-gray-400 -mt-1">Real-time API Monitoring</div>
          </div>
        </div>
        ...
        {user == null ? (
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              {/* Avatar */}
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-cyan-500 via-purple-500 to-pink-500 
            ...
            {/* Dropdown Menu */}
            {open && (
              <div className="absolute right-0 mt-3 w-64 backdrop-blur-2xl bg-gray-900/95 
                ...
                <div className="px-4 py-3 border-b border-white/10">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 via-purple-500 to-pink-500 
