...
const UserLayout = () => {
  ...
  const menuItems = [
    ...
    { name: "Manage APIs", icon: <Network size={20} />, path: "/user/apis" },
    { name: "Incidents", icon: <AlertTriangle size={20} />, path: "/user/incidents" },
    { name: "SLA Reports", icon: <BarChart size={20} />, path: "/user/reports" },
  ];
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="sticky top-0 z-20 backdrop-blur-xl bg-gray-900/80 border-b border-white/10 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Right side actions */}
            <div className="flex items-center gap-3">
              <button className="p-3 rounded-xl backdrop-blur-sm bg-white/5 border border-white/10 hover:bg-white/10 transition-all relative" onClick={()=> navigate("/")}>
                <Home size={20} />
